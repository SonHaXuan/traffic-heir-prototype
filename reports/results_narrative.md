...
- Across the seed sweep, cooperative HE-friendly performance averaged **0.8905** versus **0.8440** for local modeling, preserving an average gain of **0.0464**.
...
- The small SUMO sample (**6** samples, random split) is a pipeline sanity check only.
